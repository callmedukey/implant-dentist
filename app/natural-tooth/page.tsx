        ...
        <div className="flex flex-col items-center py-4 md:py-12 lg:py-16 **:break-keep">
          ...
          >
            <motion.div
              ...
              className="bg-teal-secondary py-4 px-4 md:px-8 lg:px-14 text-center md:text-left"
            >
          ...
          <motion.section
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
            className="w-full mt-6 md:mt-14 lg:mt-20 max-w-6xl mx-auto px-4"
          >
            <motion.div
              ...
              className="flex flex-col lg:flex-row gap-4 md:gap-6 lg:gap-6 items-stretch rounded-lg overflow-hidden"
            >
              {/* Image on the left */}
              ...
              <div className="flex flex-col justify-center gap-4 md:gap-6 lg:gap-8 lg:w-1/2 px-0 lg:px-8">
                <p className="text-14 md:text-lg lg:text-xl text-dark-primary leading-[1.6] text-center lg:text-left">
          ...
          <motion.section
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
            className="w-full mt-6 md:mt-14 lg:mt-20 mb-6 md:mb-10"
          >
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="bg-teal-secondary py-4 md:py-6 px-4 md:px-8 lg:px-14"
            >
              <div className="max-w-6xl mx-auto flex flex-col gap-2 text-center px-4">
                <p className="text-14 md:text-xl lg:text-[1.44rem] font-bold text-white leading-[1.6]">
