        ...
        <section className="pb-4 md:py-12">
          <div className="mx-auto max-w-[69.375rem] px-4">
            ...
            <motion.div
              ...
              className="relative w-[15rem] h-[15rem] md:w-[27.6rem] md:h-[27.6rem] lg:w-[34.5rem] lg:h-[34.5rem] mx-auto"
            >
              <Image
                src={specialistIcon}
                alt="구강악안면외과 전문의 아이콘"
            ...
            <motion.p
              ...
              className="text-14 md:text-xl lg:text-2xl text-dark-primary text-center max-w-5xl mx-auto break-keep mt-4 lg:mt-0"
            >
          ...
          <div className="mx-auto max-w-6xl px-4 pb-8 sm:pb-12 md:pb-16">
            ...
            >
              ...
              <motion.div
                ...
                className="relative w-full h-[15rem] md:h-[24.5rem] rounded-lg overflow-hidden"
              >
                <Image
                  src={sameDay}
                  alt="당일 사랑니 발치 시술 장면"
