...
const dropdownItems: Record<string, Array<{ text: string; href: string }>> = {
  조은이플란트치과: [
    { text: "치과 소개", href: "/about" },
    { text: "주치의 소개", href: "/doctors" },
    { text: "의료진 소개", href: "/staff" },
    { text: "치과 둘러보기", href: "/clinic-tour" },
    { text: "진료 및 예약 안내", href: "/reservation" },
  ...
  "특별한 임플란트": [
    { text: "특별한 임플란트", href: "/special-implant" },
  ...
  "자연치아 살리기": [
    { text: "치근단절제술", href: "/natural-tooth/apicectomy" },
...
const navItems = [
  ...
  { text: "턱관절 치료", href: "/tmj-treatment", hasDropdown: true },
