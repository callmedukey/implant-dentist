      ...
      <section id="whitening" className="scroll-mt-[6.25rem]">
        <div className="flex flex-col items-center py-8 md:py-12 lg:py-16">
          ...
          <motion.section
            ...
            className="w-full mt-8 md:mt-10 lg:mt-12"
          >
          ...
          <motion.section
            ...
            className="max-w-6xl mx-auto w-full px-4 md:px-8 mt-12 md:mt-16 lg:mt-20"
          >
            <div className="flex flex-col items-center gap-4 md:gap-6 lg:gap-8">
              {/* Text Content */}
              <div className="flex flex-col items-center gap-3 md:gap-4 lg:gap-5 text-center max-w-[35.938rem]">
          ...
          >
            <div className="flex flex-col lg:flex-row justify-center items-center rounded-lg overflow-hidden">
              {/* Content */}
              <div className="flex flex-col gap-6 md:gap-8 lg:gap-10 py-8 md:py-12 lg:py-16 lg:pr-8 flex-1">
                {/* Header */}
        ...
        <section className="pt-16 pb-8 md:pt-20 md:pb-12">
          <div className="mx-auto max-w-6xl px-4">
            ...
            <motion.div
              ...
              className="relative w-full h-[20rem] md:h-[28rem] lg:h-[33.25rem] rounded-lg overflow-hidden mt-8"
            >
              <Image
                src={heroBg}
                alt="충치치료"
        ...
        <section className="py-8 md:py-12">
          <div className="mx-auto max-w-6xl px-4">
            <motion.div
              ...
              viewport={{ once: true, margin: "-50px" }}
              transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
              className="border-b border-dark-primary pb-3 mb-8"
            >
            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
              ...
              <motion.div
                ...
                className="flex flex-col items-center gap-6 w-[18.75rem]"
              >
                <Image
        ...
        <section className="py-12 md:py-16">
          <div className="mx-auto max-w-6xl px-4">
            <motion.div
              ...
              viewport={{ once: true, margin: "-50px" }}
              transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
              className="border-b border-dark-primary pb-2 mb-10"
            >
      ...
      <section id="soft-tissue" className="scroll-mt-[6.25rem]">
        <div className="flex flex-col items-center py-8 md:py-12 lg:py-16 **:break-keep">
          ...
          <motion.section
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
            className="flex flex-col items-center gap-6 px-4 md:px-8 lg:px-[3.5rem] max-w-6xl mx-auto w-full"
          >
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <motion.p
                ...
                className="text-lg md:text-xl lg:text-[1.44rem] text-dark-primary leading-[1.6] max-w-5xl px-0 md:px-8 lg:px-[4.5rem] mt-2"
              >
