...
const AboutFinalSection = () => {
  return (
    <section className="w-full max-w-[--breakpoint-max] mx-auto px-4 md:px-8 py-16 md:py-24">
      <div className="max-w-[69.375rem] mx-auto flex flex-col items-center gap-12 md:gap-16">
        {/* Title and subtitle */}
        ...
        <motion.div
          ...
          className="relative w-full max-w-[69.375rem] h-[24rem] md:h-[32rem] lg:h-[36rem] rounded-lg overflow-hidden"
        >
          <Image
            src={backgroundImage}
            alt="병원 내부 환경"
